...
this.choosePath=function(){//the 4 contour lines
	...
	//return this.path;	
	//return this.path; //=['sqsqh','sqsqv','trtrh','sqsqv'];
//}this.drawPath=function(){
	...
	for (var j=0; j<4; j++){
		...
		//console.log(this.path[j], n);///path[j] is a string not array!!!
	...
	//this.ctx.rect(1,1,this.mcanvas.width-2,this.mcanvas.height-2);
	//this.ctx.stroke();
